...
'''
Program 1 reads three training files: one in English, one in Italian, and one
in French. From the files, unigram and bigram dictionaries for each language
are created, then pickled for use in program 2. 
'''
