...
'''
Program 2 uses the pickled dictionaries from Program 1 to calculate laplace probabilities 
of each line a text file being in English, French, or Italian. The results are compared with
the actual solutions for each line, and the accuracy and incorrect predictions for language
are output. 
'''
